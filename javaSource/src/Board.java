...
public class Board implements Serializable {
	...
	public void updateBoard(Board board) {
		...
		this.widths = board.widths;  // secondary arrays that store widths and heights
		this.heights = board.heights; // of filled blocks

		//backup ivars for undo
		this.gridBackup = board.gridBackup;
		this.widthsBackup = board.widthsBackup;
		this.heightsBackup = board.heightsBackup;
	}
}
