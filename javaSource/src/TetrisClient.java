...
public class TetrisClient {
	...
	public static void main(String args[]) throws IOException {
		...
		try {
			...
			System.out.println("TetrisClient 1 successfully connect to server");
			otherSock = new Socket(HOST, PORT);
			System.out.println("TetrisClient 2 successfully connect to server");
...
//		System.out.println(in);
		...
		JTetris tetris = new JTetris(16, in, out, sharedInt);
